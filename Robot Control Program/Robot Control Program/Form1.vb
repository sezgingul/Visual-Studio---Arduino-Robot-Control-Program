'Software development By Sezgin GÜL
'Personal site : www.sezgingul.com 
'Blog : www.robimek.com
Imports System.IO
Imports System
...
Public Class Form1
    ...
    Private Sub Form1_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        If (e.KeyCode = Keys.Q) Then
            ...
            TextBox1.Text = "Going left forward "
        Else
        ...
        If (e.KeyCode = Keys.E) Then
            ...
            TextBox1.Text = "Going right forward "
        Else
        ...
        If (e.KeyCode = Keys.X) Then
            ...
            TextBox1.Text = "Going left backward"
        Else
        ...
        If (e.KeyCode = Keys.Z) Then
            ...
            TextBox1.Text = "Going right backward"
        Else
    ...
    Private Sub cmbPort_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        If SerialPort1.IsOpen = False Then
            SerialPort1.PortName = ComboBox1.Text
        Else
            MsgBox("Change the connection when it is off !", vbCritical)
        End If
    End Sub
